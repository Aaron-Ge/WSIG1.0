...
public class CustomListView extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.SingularOrDoubles).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CustomListView.this,CustomLIstViewForB.class));
            }
        });
    ...
    private BaseAdapter adapter = new BaseAdapter() {
        ...
        private CustomListCellData[] data = new CustomListCellData[]{
                new CustomListCellData("Monday(单周)","1-2计算机前沿@7教北220","3-5数据库@7教北408","6-8计组@7教中3022","",R.drawable.img1),
