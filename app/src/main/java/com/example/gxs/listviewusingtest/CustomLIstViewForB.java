...
/**
 * Created by GXS on 2017/3/28.
 */

public class CustomLIstViewForB extends Activity {
    ...
    private BaseAdapter adapter = new BaseAdapter() {
        ...
        private CustomListCellData[] data = new CustomListCellData[]{
                ...
                new CustomListCellData("Sunday"," "," ","","",R.drawable.img7),
        };
        @Override
        public int getCount() {
            return data.length;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
          /*  TextView tv= null;
            ...
            if(convertView!=null){
                ...
                ll = (LinearLayout) LayoutInflater.from(CustomLIstViewForB.this).inflate(R.layout.custom_listcell,null);
            }
